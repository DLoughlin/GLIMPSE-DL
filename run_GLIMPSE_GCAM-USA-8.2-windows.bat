...
"%JAVA_EXE%" -Djava.util.logging.config.file -Dprism.order=sw --module-path "%JAVAFX_LIB%" --add-modules=javafx.controls,javafx.fxml -jar .\GLIMPSE-ScenarioBuilder\GLIMPSE-ScenarioBuilder.jar -options options_GCAM-USA-8.2-windows.txt
